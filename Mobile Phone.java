...
public class MobilePhone {
    ...
    public boolean updateContact(Contact c, Contact x){
        int i=findContact(c);
        if(i<0){
            return false;
        }
    ...
    public Contact queryContact(String s){
            int i=findContact(s);
            return i<0?null:myContacts.get(i);
        }
...
public class Contact {
    ...
    public static Contact createContact(String n,String pn){
        return new Contact(n,pn);
    }
}
